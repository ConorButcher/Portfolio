...
if (array_key_exists('email', $_POST)) {
    ...
    $mail->setFrom('conor@butcher.com', 'conorbutcher.co.uk'); //**Write here sender email. For example, emails will be sent to you from your website, so write email of your website (if you don't have it, write any email, which you want) and the name of your website. Example ('email@your-website.com', 'your-website.com')) Send from a fixed, valid address in your own domain, perhaps one that allows you to easily identify that it originated on your contact form**
    
    //Send the message to yourself, or whoever should receive contact for submissions
    
    $mail->addAddress('conorbutcher26@outlook.com'); //**WRITE HERE RECIPIENT EMAIL ADDRESS (AT THIS ADDRESS EMAILS WILL BE COME)**
